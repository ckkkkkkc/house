    ...
    <script language="JavaScript">
        $(function () {
            ...
            $('#dg').datagrid({
                ...
                columns: [[
                    {field: 'cb', checkbox: true},//开启复选框
                    {field: 'id', title: '编号', width: 100},
                    {field: 'name', title: '房屋名称', width: 100},
                    {
                        field: 's', title: '操作', width: 100,
                        formatter: function (value, row, index) {
                            var str = "<a href='javascript:deleteDis(" + row.id + ");'>删除</a>|<a href='javascript:updateDialog()'>修改</a>"
                            return str;
                        }
                    }
                ]]
        ...
        function updateDialog() {
            ...
            if (SelectRows.length == 1) {
                ...
                //发异步请求查询数据库
                $.post("seleteOneType", {"id": SelectRows[0].id}, function (data) {
...
<div id="AddDialog" class="easyui-dialog" title="添加窗口" buttons="#AddDialogButtons"
    ...
    <form method="post" action="addType" name="form1" id="form1">
        房屋类型:<input type="text" name="name">
    </form>
</div>
<!--2 添加对话框的按钮-->
...
<div id="updateDialog" class="easyui-dialog" title="修改窗口" buttons="#updateDialogButtons"
     style="width: 280px; height: 250px; padding: 10px 20px;" closed="true">
    <form method="post" action="update" name="form2" id="form2">
